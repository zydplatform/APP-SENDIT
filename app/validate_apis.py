class Validation:
    ...
    def invalid_inputs(self,parcel_name, parcel_weight, parcel_description, parcel_price, pickup, destination, status):
        errors_found = {}
    ...
    def empty_field(self,parcel_name, parcel_weight, parcel_description, parcel_price, pickup, destination, status):
        errors_found = {}
        if not parcel_name:
